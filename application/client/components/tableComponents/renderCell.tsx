import { ReportTeamResponse, ValueTypesOutput } from "@/extensions/data-contracts";
import { FlatMappedOutputs } from "@/types/tableDefinitions";
import { Tooltip, Progress, Chip } from "@nextui-org/react";


const renderCell = (item: ReportTeamResponse[], columnKey: string, flatMappedOutputs: FlatMappedOutputs[]) => {
